...
| **US04** | Alta | **Como usuário**, desejo acessar a estrutura inicial do site web, mesmo sem os dados reais conectados, para visualizar a futura organização do sistema. | - Esqueleto inicial do site criado utilizando HTML5 e CSS3.<br>- Estrutura inicial versionada no GitHub.<br>- Código organizado para receber futuras integrações com os dados processados. | |
